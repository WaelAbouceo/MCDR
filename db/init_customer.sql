-- Customer Data Zone — isolated read-only database (MySQL)
...
CREATE INDEX idx_cp_phone   ON customer_profiles(phone_number);
CREATE INDEX idx_cp_account ON customer_profiles(account_number);

-- Sample data
INSERT IGNORE INTO customer_profiles (phone_number, name, account_number, account_tier) VALUES
